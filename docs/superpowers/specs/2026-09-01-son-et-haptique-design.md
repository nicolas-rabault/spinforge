...
| `reward(chests)` | **les pièces dans la caisse** : 4 grains (+1 si un coffre est tombé), bruit passe-bande 1 800 → 3 200 Hz Q 6, 25 ms chacun, espacés de 45 ± 15 ms, hauteur montante — puis un fond de caisse, sinus fa2 (87,31 Hz), 90 ms | ~0,3 s |
