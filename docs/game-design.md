...
- Mort du joueur → **fin du run** (`RunState.phase` passe à `'dead'`), crédits conservés ; l'écran de combat propose de retenter le chapitre perdu, présélectionné.
